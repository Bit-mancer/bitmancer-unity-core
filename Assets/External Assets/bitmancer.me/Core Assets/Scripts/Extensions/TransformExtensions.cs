...
namespace Bitmancer.Core.Extensions {
    ...
    public static class TransformExtensions {
        ...
        public static T GetRequiredComponent<T>( this Transform self ) where T : Component {
        ...
        public static T GetRequiredComponentInChildren<T>( this Transform self ) where T : Component {
        ...
        public static T GetRequiredComponentInParent<T>( this Transform self ) where T : Component {
